      ...
      <v-card class="elevation-12">
        ...
        <v-card-text class="mt-3 mb-0">
          <v-form @submit.prevent="submit" ref="form">
            ...
            <span class="ml-8 text-overline">참여 허용인원 : {{form.acceptableMaxCount}}명</span>
